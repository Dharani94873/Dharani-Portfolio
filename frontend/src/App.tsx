          ...
          <div className="hidden md:flex gap-8 text-sm font-medium">
            {navLinks.map(link => (
              <a
                ...
                className={`transition-colors ${activeSection === link.toLowerCase() ? 'text-primary font-semibold' : 'text-slate-600 hover:text-primary'}`}
              >
                {link}
              </a>
            ))}
              ...
              <div className="flex flex-col px-6 py-4 gap-4">
                {navLinks.map(link => (
                  <a
                    ...
                    href={`#${link.toLowerCase()}`}
                    onClick={closeMenu}
                    className="text-slate-700 font-medium hover:text-primary transition-colors py-1"
                  >
                    {link}
                  </a>
                ))}
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="/resume.pdf" download className="px-8 py-3 border-2 border-slate-200 text-slate-700 rounded-full font-bold hover:border-primary hover:text-primary transition-all flex items-center gap-2">
                <FiDownload /> Resume
              </a>
            </div>
                ...
                <div className="p-7 flex flex-col flex-1">
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag, j) => (
                      <span key={j} className="px-3 py-1 bg-primary/5 group-hover:bg-primary/10 text-primary text-xs font-bold rounded-full uppercase tracking-wider transition-colors duration-300">{tag}</span>
                    ))}
                  </div>
                  <h3 className="text-xl font-bold mb-2 text-slate-900 group-hover:text-primary transition-colors duration-300">{project.title}</h3>
                  ...
                  <div className="flex gap-4">
                    ...
                    <a href={project.github} className="flex items-center gap-2 text-slate-700 font-bold hover:text-slate-900 transition-all text-sm">
                      <FiGithub /> Code
                    </a>
                  </div>
                </div>
            ...
            <div>
              ...
              >
                ...
                <p className="text-slate-700 text-sm leading-relaxed">
                  Building AI tools, contributing to open-source projects, and developing web development projects for small businesses.
                </p>
              </motion.div>
            </div>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {group.skills.map((skill, si) => (
                    ...
                    >
                      ...
                      <span className="text-xs font-semibold text-slate-700 group-hover:text-slate-900 transition-colors">{skill.name}</span>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="glass p-10 rounded-3xl border border-slate-100 shadow-lg space-y-6 flex flex-col justify-center">
              <a href="mailto:dharani94873@gmail.com" className="flex items-center gap-4 text-slate-700 hover:text-primary transition-colors group">
              ...
              <a href="https://github.com/" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-slate-700 hover:text-primary transition-colors group">
                <div className="p-4 bg-slate-50 rounded-xl group-hover:bg-primary/10 transition-colors">
              ...
              <a href="https://linkedin.com/" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-slate-700 hover:text-primary transition-colors group">
                <div className="p-4 bg-slate-50 rounded-xl group-hover:bg-primary/10 transition-colors">
      ...
      <footer className="py-16 border-t border-slate-100 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-10 items-center text-center md:text-left">
          <div>
            ...
            <p className="text-slate-700 text-sm max-w-xs">Building the future of the web, one component at a time.</p>
          </div>
